      ...
      <div className="flex flex-col gap-y-10 mt-[60px] text-[var(--darkBrown)] justify-start items-center p-12">
        ...
        <div className="flex flex-col justify-start items-start gap-y-5 w-full">
          ...
          <div className="text-xs">
            ...
            <br />
            <br />
            You can contact us by phone at +447972707742, email at
            ...
            <br /> The Services are intended for users who are at least 13 years
        ...
        <div className="flex flex-col justify-start items-start gap-y-5 w-full">
          <div className="text-2xl font-medium">Table of Contents</div>
          <ol className="text-xs list-decimal pl-6">
            ...
            <li><a href="#limitations">Limitations Of Legality</a></li>
            <li><a href="#indemnification">Indemification</a></li>
        ...
        <div className="flex flex-col justify-start items-start gap-y-5 w-full" id="ourservices">
          <div className="text-2xl font-medium">1. Our Services</div>
        ...
        <div className="flex flex-col justify-start items-start gap-y-5 w-full" id="intellectual">
          <div className="text-2xl font-medium">
          ...
          <div className="text-xs pl-6">
            ...
            please address your request to: info@coffee-culture.uk. If we ever
          ...
          <div className="text-xs pl-6">
            ...
            <br /> Contributions: The Services may invite you to chat,
        ...
        <div className="flex flex-col justify-start items-start gap-y-5 w-full" id="userrep">
          <div className="text-2xl font-medium">3. User Representations</div>
          <div className="text-xs pl-6">
        ...
        <div className="flex flex-col justify-start items-start gap-y-5 w-full" id="userreg">
          <div className="text-2xl font-medium">4. User Registration</div>
          <div className="text-xs pl-6">
        ...
        <div className="flex flex-col justify-start items-start gap-y-5 w-full" id="purchases">
          <div className="text-2xl font-medium">5. Purchases And Payment</div>
          <div className="text-xs pl-6">
            ...
            purchased per person, per household, or per order. <br />
            <br />
            ...
            or prohibit orders that, in our sole judgement, appear to be placed
            by dealers, resellers, or distributors.
          </div>
        </div>
        <div className="flex flex-col justify-start items-start gap-y-5 w-full" id="subscriptions">
          <div className="text-2xl font-medium">6. Subscriptions</div>
          <div className="text-xl font-medium pl-6">Billing And Renewal</div>
          <div className="text-xs pl-6">
          ...
          <div className="text-xs pl-6">
            ...
            our Services, please email us at info@coffee-culture.uk.
          </div>
          <div className="text-xl font-medium pl-6">Fee Changes</div>
          <div className="text-xs pl-6">
        ...
        <div className="flex flex-col justify-start items-start gap-y-5 w-full" id="software">
          <div className="text-2xl font-medium">7. Software</div>
          <div className="text-xs pl-6">
            ...
            out of use or performance of any software. You may not reproduce or
            redistribute any software except in accordance with the EULA or
            these Legal Terms.
          </div>
        </div>
        <div className="flex flex-col justify-start items-start gap-y-5 w-full" id="prohibitedactivities">
          <div className="text-2xl font-medium">8. Prohibited Activities</div>
          <div className="text-xs pl-6">
        ...
        <div className="flex flex-col justify-start items-start gap-y-5 w-full" id="usergenerated">
          <div className="text-2xl font-medium">
        ...
        <div className="flex flex-col justify-start items-start gap-y-5 w-full" id="contributionlicense">
          <div className="text-2xl font-medium">10. Contribution License</div>
          <div className="text-xs pl-6">
            ...
            <br /> This licence will apply to any form, media, or technology now
            ...
            retain full ownership of all your Contributions and any intellectual
            ...
            the Services, and you expressly agree to exonerate us from all
        ...
        <div className="flex flex-col justify-start items-start gap-y-5 w-full" id="mobile">
          <div className="text-2xl font-medium">
            11. Mobile Application License
          </div>
          <div className="text-xl font-medium pl-6">Use Licence</div>
          <div className="text-xs pl-6">
        ...
        <div className="flex flex-col justify-start items-start gap-y-5 w-full" id="social">
          <div className="text-2xl font-medium">12. Social Media</div>
          <div className="text-xs pl-6">
        ...
        <div className="flex flex-col justify-start items-start gap-y-5 w-full" id="thirdparty">
          <div className="text-2xl font-medium">
        ...
        <div className="flex flex-col justify-start items-start gap-y-5 w-full" id="servicesmanage">
          <div className="text-2xl font-medium">14. Services Management</div>
          <div className="text-xs pl-6">
        ...
        <div className="flex flex-col justify-start items-start gap-y-5 w-full" id="privacy">
          <div className="text-2xl font-medium">15. Privacy Policy</div>
          <div className="text-xs pl-6">
            We care about data privacy and security. Please review our Privacy
            Policy: https://www.coffee-culture.uk/privacy-policy. By using the
            ...
            are hosted in the United Kingdom. If you access the Services from
        ...
        <div className="flex flex-col justify-start items-start gap-y-5 w-full" id="copyright">
          <div className="text-2xl font-medium">
        ...
        <div className="flex flex-col justify-start items-start gap-y-5 w-full" id="term">
          <div className="text-2xl font-medium">17. Term And Termination</div>
          <div className="text-xs pl-6">
        ...
        <div className="flex flex-col justify-start items-start gap-y-5 w-full" id="modifications">
          <div className="text-2xl font-medium">
        ...
        <div className="flex flex-col justify-start items-start gap-y-5 w-full" id="governinglaw">
          <div className="text-2xl font-medium">19. Governing Law</div>
          <div className="text-xs pl-6">
            ...
            Coffee Culture London LTD and yourself both agree to submit to the
            non-exclusive jurisdiction of the courts of London, which means that
            you may make a claim to defend your consumer protection rights in
            regard to these Legal Terms in the United Kingdom, or in the EU
            country in which you reside.
          </div>
        </div>
        <div className="flex flex-col justify-start items-start gap-y-5 w-full" id="dispute">
          <div className="text-2xl font-medium">20. Dispute Resolution</div>
          ...
          <div className="text-xl font-medium pl-6">Binding Arbitration</div>
          <div className="text-xs pl-6">
          ...
          <div className="text-xl font-medium pl-6">Restrictions</div>
          <div className="text-xs pl-6">
        ...
        <div className="flex flex-col justify-start items-start gap-y-5 w-full" id="corrections">
          <div className="text-2xl font-medium">21. Corrections</div>
          <div className="text-xs pl-6">
        ...
        <div className="flex flex-col justify-start items-start gap-y-5 w-full" id="disclaimer">
          <div className="text-2xl font-medium">22. Disclaimer</div>
          <div className="text-xs pl-6">
        ...
        <div className="flex flex-col justify-start items-start gap-y-5 w-full" id="limitations">
          <div className="text-2xl font-medium">
          ...
          <div className="text-xs pl-6">
            ...
            TO THE AMOUNT PAID, IF ANY, BY YOU TO US DURING THE ONE (1) MONTH
            PERIOD PRIOR TO ANY CAUSE OF ACTION ARISING. CERTAIN US STATE LAWS
        ...
        <div className="flex flex-col justify-start items-start gap-y-5 w-full" id="indemnification">
          <div className="text-2xl font-medium">24. Indemnification</div>
          <div className="text-xs pl-6">
        ...
        <div className="flex flex-col justify-start items-start gap-y-5 w-full" id="userdata">
          <div className="text-2xl font-medium">25. User Data</div>
          <div className="text-xs pl-6">
        ...
        <div className="flex flex-col justify-start items-start gap-y-5 w-full" id="electronic">
          <div className="text-2xl font-medium">
        ...
        <div className="flex flex-col justify-start items-start gap-y-5 w-full" id="sms">
          <div className="text-2xl font-medium">27. SMS Text Messaging</div>
          ...
          <div className="text-xl font-medium pl-6">Support</div>
          <div className="text-xs pl-6">
            If you have any questions or need assistance regarding our SMS
            communications, please email us at info@coffee-culture.uk or call at
            +447972707742.
          </div>
        </div>
        <div className="flex flex-col justify-start items-start gap-y-5 w-full" id="miscellaneous">
          <div className="text-2xl font-medium">28. Miscellaneous</div>
          <div className="text-xs pl-6">
        ...
        <div className="flex flex-col justify-start items-start gap-y-5 w-full" id="contactus">
          <div className="text-2xl font-medium">29. Contact Us</div>
          <div className="text-xs pl-6">
            In order to resolve a complaint regarding the Services or to receive
            further information regarding use of the Services, please contact us
            at: <br />
            <br />
            Coffee Culture London LTD <br />
            26 Beverly House <br />
            133 Park Road <br />
            London, London NW8 7JD <br />
            United Kingdom <br />
            Phone: +447972707742  <br />
            info@coffee-culture.uk
          </div>
        </div>
      </div>
    </div>
